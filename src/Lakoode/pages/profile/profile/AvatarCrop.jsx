...
const AvatarCrop = ({
  ...
  return (
    <div className="fixed flex justify-center lg:inset-20 w-full items-center">
      <div
        className={`z-[19]   w-[300px] h-[400px] flex flex-col items-center justify-between rounded-xl bg-border bg-opacity-80 backdrop-blur-sm top-[20%] left-[40%] `}
      >
        ...
        <div className="flex self-center mx-2 mb-5 text-white">
          ...
          <div>
            <button
              ...
              className="h-[40px] px-3  self-center rounded-3xl  bg-btn hover:bg-blue-900 duration-200 flex flex-col justify-center items-center "
            >
