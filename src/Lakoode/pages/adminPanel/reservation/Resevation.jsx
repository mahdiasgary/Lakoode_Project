...
const Resevation = () => {
  ...
  let reservDays =[ {date:rangeDays.f,
  prise,
  discount,
  disLable,
  incLable,
  ...
  return (
    <div>
      ...
      <div className="mt-10 bg-white  mx-5  dark:bg-border lg:mx-10 p-5 rounded-3xl">
        <div>
          <p className="text-lg font-semibold">تعیین قیمت در {reservDays.map(d=><span className="mx-1 px-2 w-10">{ d.date}-</span>)} تیر 1402</p>
        </div>
        <div className="flex mt-8 lg:justify-between lg:flex-row flex-col justify-start">
          <div>
            ...
            <div className="flex flex-row my-4 ">
              <p className="md:self-center self-center">میزان تخفیف را وارد کنید</p>
              <div>
                <input
                  ...
                  type="text"
                  dir="ltr"
                  className="text-[20px] ml-1 dark:bg-textPDark font-semibold outline-none focus:ring-2 focus:ring-btn  bg-screenLight px-2 w-16 h-12 mr-4 rounded-2xl"
                />
                %
              </div>
            </div>
      ...
      <div className="mt-10 bg-white  mx-2  dark:bg-border lg:mx-10 px-3 lg:p-5 rounded-3xl">
        <Calandre seletedDays={seletedDays} setRangeDays={setRangeDays} rangeDays={rangeDays} />
      </div>
    </div>
  );
};
