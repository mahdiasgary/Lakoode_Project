...
const Ritem = ({ user, removeUserHandler, setmobile, history }) => {
  ...
  return (
    <tr className=" py-10 rounded-xl  hover:text-screenLight dark:text-[#d1d1d3] group border-b dark:border-0  ">
      ...
      <td>
        <div className="flex px-2 text-btn group-hover:dark:bg-[#24272e] group-hover:bg-[#6d7077] duration-300 self-center h-[64px] flex-col justify-center text-center my-1">
