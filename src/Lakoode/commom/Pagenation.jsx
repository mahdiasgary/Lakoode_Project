...
const Pagenation = ({item,totalCount,correctPage,setCorrectPage}) => {
    let pages = [];
    for (let i = 1; i <=Math.ceil(totalCount/ 10)
    ; i++) {
      pages.push(i);
    };
  return (
<div
            className={`py-3 ${
              !totalCount && "hidden"
            } mx-2 self-center flex justify-between  `}
          >
            <div className="self-center text-sm ">
              <span className="px-2 text-gray-500">تعداد {item}</span>
              {totalCount}
            </div>
            <div dir="ltr" className={`flex  `}>
              ...
              <div
                ...
                } flex h-10 flex-col justify-center text-gray-400`}
              >
                ...
              </div>
              ...
              <div
                ...
                } h-10 w-10 pt-1 flex flex-col justify-center text-center rounded-[50%] border-2  text-gray-400 hover:border-btn dark:border-border hover:text-btn cursor-pointer duration-200 mx-1 `}
              >
                {correctPage - 1 > 0 ? correctPage - 1 : ""}
              </div>
              <div className="h-10 w-10 pt-1 flex flex-col justify-center text-center rounded-[50%] bg-btn mx-1 text-white">
                {correctPage}
              </div>
              <div
                onClick={() => setCorrectPage(correctPage + 1)}
