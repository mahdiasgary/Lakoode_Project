...
const CalandreDetalis = ({
  ...
  return (
    ...
    >
      ...
      className="bg-white dark:bg-border rounded-3xl lg:w-[60vw]  ">
              ...
              {days.slice(t[0], t[1]).map((d) => (
                ...
                >
                  <div
                    ...
                    } ${hoveredDay.find(day=>day===d) && 'dark:bg-gray-600 bg-gray-200' }  rounded-2xl h-[70px] lg:h-[75px] flex flex-col justify-center duration-200 `}
                  >
                    <div
                      className={`text-[18px] ${
