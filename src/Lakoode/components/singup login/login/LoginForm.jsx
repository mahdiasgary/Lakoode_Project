...
const LoginForm = ({ Formik, loginUserHandler, loadingButton }) => {
  ...
  return (
    <div className="fa   bg-[#f9f9f9] dark:bg-[#282a37]  w-full  flex justify-center xl:justify-start  ">
      <div className="item-center self-center ">
        ...
        <p className="text- opacity-70  mt-3">لطفا اطلاعات خود را وارد کنید</p>
          ...
          <div className="flex justify-center">
           ...
           dark:bg-[#323645]  w-[90vw] md:w-[440px] "
              >
                ...
                <div className=" flex  pl-5  h-[58px] ">
...
رمز عبور را فراموش کرده اید؟          </p>
        </Link>

        {/* singup button */}
        <p className=" mx-1">
هنوز ثبت نام نکردی؟          <span className="text-btn m-1 font-semibold  text-[16px] ">
